...
/**
 * SISPAG Santander — Segmento O (concessionárias / tributos com código de barras).
 *
 ...
 *
 * @see sispag_cnab_SANTANDER.txt — SEGMENTO O – OBRIGATÓRIO / Anexo B
...
class Registro3O extends Generico3 {
     ...
     * Motivo: Santander Anexo B consistência a representação numérica com módulo 10 nos campos;
