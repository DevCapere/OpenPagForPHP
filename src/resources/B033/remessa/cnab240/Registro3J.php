...
/**
 * SISPAG Santander — Segmento J (liquidação de boleto).
 *
 * @see sispag_cnab_santander_B341.txt — REGISTRO DETALHE SEGMENTO J
 */
class Registro3J extends Generico3 {
    ...
    public static function formaPagamentoPorCodigoBarras(string $codigoBarras): string {
        return substr($codigoBarras, 0, 3) === '033' ? '30' : '31';
    }
    ...
    private function inserirSegmentoJ52(array $data): void {
        // Sequencial próprio (00002…): alinhado a remessas aceitas pelo Santander/portal.
